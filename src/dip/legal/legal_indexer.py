...
LEGAL_MEMORY_PATH = DATA_DIR / "legal_memory"
...
def build_legal_index(
    ...
    from dip.core.legal.legal_loader import LegalLoader
    from dip.core.legal.legal_splitter import split_legal_document
