...
class AllianceSpecialist(BaseSpecialist):
    def __init__(self, message_bus: MessageBus):
        mandate = (
            "Focus: alliance commitments, security guarantees, joint exercises, basing rights, intelligence sharing, coalition dynamics. "
            "Answer: 'How do alliance structures constrain or enable this action?'"
        )
...
{{
    ...
    "probability": 0.62,
    "confidence": 0.75,
    "reasoning_summary": "Explanation of your reasoning based on alliance and coalition indicators."
}}"""
        try:
