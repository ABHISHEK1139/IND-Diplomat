...
from dip.pipeline.memory.backtesting.multiclass_metrics import (
    MulticlassMetrics,
    compute_all_metrics,
)
from dip.pipeline.memory.backtesting.replay_engine import (
    ReplayResult,
    replay_scenario,
)
from dip.pipeline.memory.backtesting.scenario_registry import BacktestScenario
...
def shadow_comparison(
    ...
    try:
        ...
        # ── Restore (always, even on exception) ─────────────────────
